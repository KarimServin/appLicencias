...
import com.municipalidad.licencias.appLicencias.ui.Licencia;
import com.municipalidad.licencias.appLicencias.ui.Presupuesto;
...
public class PDFService {
     ...
     public void imprimirLicencia(Titular titular) {
        Licencia licenciaPanel = new Licencia(titular);
...
// Ahora sí, se puede imprimir
    ...
    public void imprimirComprobante(Titular titular,int Monto) {
        Presupuesto presupuesto = new Presupuesto(titular,Monto);
        JFrame frame = new JFrame();
