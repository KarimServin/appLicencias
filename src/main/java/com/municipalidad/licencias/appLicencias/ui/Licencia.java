 ...
 * @author pabli
 */
public class Licencia extends javax.swing.JPanel implements Printable{

    public Licencia() {
        initComponents();
    }
    public Licencia(String tipo, String nombre, String apellido, String fechaNacimiento, String fechaVencimiento,int documento,String Direccion,boolean donante,String grupoSanguineo) {
        initComponents();
        setearDatos(tipo, nombre,  apellido,  fechaNacimiento,  fechaVencimiento, documento,Direccion,donante, grupoSanguineo);
    }
 public Licencia(Titular titular) {
        initComponents();
     ...
     */
    public void setearDatos(String tipo, String nombre, String apellido, String fechaNacimiento, String fechaVencimiento,int documento,String Direccion,boolean donante,String grupoSanguineo){
        String dni= String.valueOf(documento);
        String donantee;
        if(donante){
            donantee = "SI";
        }else{
        ...
        txtTipoLicencia.setText(tipo);
        txtLicencia.setText(dni);
        txtApellido.setText(apellido);
        txtNombre.setText(nombre);
        txtDireccion.setText(Direccion);
        txtGrupoSanguineo.setText(grupoSanguineo);
        txtDonante.setText(donantee);
    ...
    private void initComponents() {
        ...
        txtNombre.setText("JUAN PABLO");
        add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, -1, -1));
        ...
        add(txtFechaVencimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, 200, -1));
        ...
        add(txtGrupoSanguineo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 80, -1));

        txtDonante.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        txtDonante.setText("SI");
        add(txtDonante, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 280, 190, -1));

        jLabel9.setText("Donante");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 260, -1, -1));

        jLabel12.setText("Fecha de Vencimiento");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, -1, -1));
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 470, 320));
