...
import com.municipalidad.licencias.appLicencias.navigation.MenuOptionsListener;
...
public class PantallaMenuPrincipal extends javax.swing.JFrame {
    ...
    private final MenuOptionsListener menuOptionsListener;
    private final SessionInfo sessionInfo;
     
    public PantallaMenuPrincipal(MenuOptionsListener menuOptionsListener, SessionInfo sessionInfo) {
        
        this.menuOptionsListener = menuOptionsListener;
        this.sessionInfo = sessionInfo;
        
        initComponents();
        
        if(sessionInfo.esSuperusuario()) {
        
            btnAltaUsuario.setEnabled(true);
            btnModificarDatosUsuario.setEnabled(true);
    ...
    private void initComponents() {
        ...
        labelBienvenidaNombre.setText("Bienvenido, " + sessionInfo.getNombreUsuarioActual());
    ...
    private void btnEmitirNuevaLicenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEmitirNuevaLicenciaActionPerformed
        ...
        menuOptionsListener.mostrarPantallaEmitirLicencia();
    ...
    private void btnAltaTitularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaTitularActionPerformed
        menuOptionsListener.mostrarPantallaCargarTitular();
        this.setVisible(false);
    ...
    private void btnListarLicExpiradasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarLicExpiradasActionPerformed
        ...
        menuOptionsListener.mostrarPantallaListarLicenciasVencidas();
        this.setVisible(false);
    ...
    private void btnListarLicVigentesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarLicVigentesActionPerformed
        ...
        menuOptionsListener.mostrarPantallaListarLicencias();
        this.setVisible(false);
    ...
    private void btnAltaUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaUsuarioActionPerformed
        ...
        menuOptionsListener.mostrarPantallaCrearUsuario();
        this.setVisible(false);
    ...
    private void btnModificarDatosUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarDatosUsuarioActionPerformed
        ...
        menuOptionsListener.mostrarPantallaModificarUsuario();
        this.setVisible(false);
    ...
    private void btnEmitirCopiaLicenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEmitirCopiaLicenciaActionPerformed
        ...
        menuOptionsListener.mostrarPantallaEmitirCopiaLicencia();
        this.setVisible(false);
    ...
    private void btnRenovarLicenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRenovarLicenciaActionPerformed
        menuOptionsListener.mostrarPantallaRenovarLicencia();
        this.setVisible(false);
